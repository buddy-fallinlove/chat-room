              ...
              <div v-for="(item1,index1) in arr" :key="index1">
                ...
                <div v-else>
                  <div v-if="item1.username === username">
                    <div class="d-f user">
                      <div v-if="item1.img">
                        <img :src="item1.img" alt style="maxWidth:400px;maxHeight:300px" />
                      </div>
                  ...
                  <div v-else>
                    <div class="d-f m-t2">
                      ...
                      <div v-if="item1.img">
                        <img :src="item1" alt style="maxWidth:400px;maxHeight:300px" />
                      </div>
                      <div v-slse>
                        <div class="pian">{{item1.msg}}</div>
                      </div>
            ...
            <div class="box-ft">
              ...
              <div class="toolbar">
                <a href="javascript:;" title="表情" class="face">
                  <img src="../assets/笑脸.png" alt class="ytr" @click="clickitem" />
                </a>
...
export default {
  ...
  methods: {
    change(e) {
      ...
      fr.onload = () => {
        this.all = fr.result;
        this.$refs.content.innerHTML = `<img src="${fr.result}" style="width:100px;">`;
      };
    },
    // 点击选中表情
    addEmoji(e) {
