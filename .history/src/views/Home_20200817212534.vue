<template>
  <div>
    <div>
      <img src="../assets/u=1096344923,2764059249&fm=26&gp=0.jpg" alt=""  class="tp">
    </div>
    <div class="dv">
      <div>
      ...
      <div class="yh">
        <div class="yh1">用户名</div>
        <input type="text" placeholder="请输入用户名" class="yh2">
      </div>
      <div class="xz">
        <div class="xz1">选择头像</div>
        <div class="xz2">
          <div class="tpw">
            <div v-for="(item,index) in imgList" :key="index">
              <img :src="item.name" alt="" class="tpy">
            </div>
          </div>
        </div>
        <button type="" class="but" style="?android:attr/borderlessButtonStyle">登录</button>
      </div>
    </div>
...
.dv {
  ...
  position: absolute;
  top: 150px;
  background: rgba($color: #bdabb2, $alpha: 0.5);
  border-radius: 10px;
}
.dl {
  font-size: 26px;
