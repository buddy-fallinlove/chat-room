    ...
    <div class="beijing">
      <div class="box">
        ...
        <div class="box2">
          ...
          <div class="box-ft">
            <div class="toolbar">
              <div href="javascript:;" title="表情" class="face"></div>
              <div href="javascript:;" title="截屏" class="screen-cut"></div>
              <div href="javascript:;" title="图片" class="file">
...
.box-ft .toolbar .face {
  ...
  width: 30px;
  height: 30px;
  background: url('../../assets/biao1.png') no-repeat -404px -398px;
}
.box-ft .toolbar .screen-cut {
  ...
  width: 30px;
  height: 30px;
  background: url('../../assets/剪刀.png') no-repeat -30px -432px;
}
</style>